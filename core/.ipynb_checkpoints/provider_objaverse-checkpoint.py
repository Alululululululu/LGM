...
class ObjaverseDataset(Dataset):
    ...
    def __init__(self, opt: Options, training=True):
        ...
        # Load the list of objects for training
        self.items = []
        with open('processed_glb_files.txt', 'r') as f:
    ...
    def __getitem__(self, idx):
        ...
        # Choose views, based on your rendering settings
        if self.training:
        ...
        for vid in vids:
            image_path = os.path.join('objaverse_data_processed', uid, 'rgb', f'{vid:03d}.png')
            camera_path = os.path.join('objaverse_data_processed', uid, 'pose', f'{vid:03d}.txt')
            ...
            with open(camera_path, 'r') as f:
                c2w = [float(t) for t in f.read().strip().split()]
